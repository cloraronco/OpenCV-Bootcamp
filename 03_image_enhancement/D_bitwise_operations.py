...
plt.subplot(121), plt.title("Rectangle", fontsize=18), plt.imshow(img_rec, cmap="gray")
plt.subplot(122), plt.title("Circle", fontsize=18), plt.imshow(img_cir, cmap="gray")
...
plt.subplot(131), plt.imshow(resultAND, cmap="gray"), plt.title("Bitwise AND", fontsize=18)

# Bitwise OR Operator
resultOR = cv2.bitwise_or(img_rec, img_cir, mask=None)
plt.subplot(132), plt.imshow(resultOR, cmap="gray"), plt.title("Bitwise OR", fontsize=18)

# Bitwise XOR Operator
resultXOR = cv2.bitwise_xor(img_rec, img_cir, mask=None)
plt.subplot(133), plt.imshow(resultXOR, cmap="gray"), plt.title("Bitwise XOR", fontsize=18)

plt.savefig("images/bitwise_operator.png")
plt.show()


plt.imshow(resultAND, cmap="gray"), plt.title("Bitwise AND", fontsize=18)
plt.savefig("images/bitwise_AND.png")

plt.imshow(resultOR, cmap="gray"), plt.title("Bitwise OR", fontsize=18)
plt.savefig("images/bitwise_OR.png")

plt.imshow(resultXOR, cmap="gray"), plt.title("Bitwise XOR", fontsize=18)
